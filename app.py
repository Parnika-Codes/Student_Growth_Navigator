...
# ADDED: Earning & Monetization Metrics Section
st.markdown(f"""
<div class="income-box">
    <h4 style="margin-top: 0; color: #10B981; font-weight: 700; font-size: 18px;">💰 Estimated Side-Income Potential</h4>
    <p style="font-size: 22px; font-weight: 800; margin-bottom: 8px;">{selected['est_pay']}</p>
    <p style="color: #94A3B8; font-size: 14px; line-height: 1.5; margin: 0;">
        <b>How it works:</b> {selected['gig_breakdown']}
    </p>
</div>
""", unsafe_allow_html=True)
...
with st.form("lead_form", clear_on_submit=True):
    ...
    consent = st.checkbox(
        "I agree to receive my custom roadmap and occasional learning & Earning updates."
    )

    submit = st.form_submit_button("🚀 Get my Free Consultation & Start Earning")
...
if submit:
    ...
    if not first_name.strip():
        ...
        st.error("Please give consent to receive your roadmap.")
    else:
        payload = {
